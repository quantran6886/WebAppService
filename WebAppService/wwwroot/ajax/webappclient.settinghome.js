    ...
    LoadMenu: function () {
        $.ajax({
            ...
            success: function (data) {
                if (data.status === true) {
                    var htmlChuyenKhoa = '';
                    var htmlChuyenKhoamoblie = '<li><a class="sub-menu-lst" href="/Service/ServiceList"  style="font-weight: 500 !important; font-family: Inter;">Tất cả</a></li>';
                    var htmlDichVu = '';
                    var htmlDichVumoblie = '<li><a class="sub-menu-lst" href="/Service/ServiceList"  style="font-weight: 500 !important; font-family: Inter;">Tất cả</a></li>';
                    var htmlBaiViet = '';
                    var htmlBaiVietmoblie = '<li><a class="sub-menu-lst" href="/Blog/Blog"  style="font-weight: 500 !important; font-family: Inter;">Tất cả</a></li>';
