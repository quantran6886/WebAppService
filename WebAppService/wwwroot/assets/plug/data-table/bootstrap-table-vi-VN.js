	...
	$.fn.bootstrapTable.locales['vi-VN'] = $.fn.bootstrapTable.locales['vi'] = {
		...
		formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
			if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
				return "".concat(pageFrom, " / ").concat(pageTo, " trên ").concat(totalRows, " b\u1EA3n ghi (\u0111\u01B0\u1EE3c l\u1ECDc t\u1EEB t\u1ED5ng ").concat(totalNotFiltered, " h\xE0ng)");
			}
			return "".concat(pageFrom, " / ").concat(pageTo, " trên ").concat(totalRows, " b\u1EA3n ghi");
		},
